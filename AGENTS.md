...
- **Support SVG Debugging**: For 2D/Side-View SVG debugging rules, output paths (`~/Library/Application Support/OrcaSlicer/SVG/`), and customization entry points in `SupportMaterial.cpp`, refer to [docs/SVG_DEBUG_GUIDE.md](docs/SVG_DEBUG_GUIDE.md).
