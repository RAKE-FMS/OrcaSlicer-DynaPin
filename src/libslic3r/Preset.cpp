...
static std::vector<std::string> s_Preset_print_options {
    ...
    "brim_width", "brim_object_gap", "brim_use_efc_outline", "brim_type", "brim_ears_max_angle", "brim_ears_detection_length", "enable_support", "enable_dynapin_support_optimization", "dynapin_selected_pins", "dynapin_debug_stage", "support_type", "support_threshold_angle", "support_threshold_overlap","enforce_support_layers",
...
static std::vector<std::string> s_Preset_printer_options {
    ...
    "use_relative_e_distances", "extruder_type", "use_firmware_retraction", "printer_notes", "dynapin_config_path",
