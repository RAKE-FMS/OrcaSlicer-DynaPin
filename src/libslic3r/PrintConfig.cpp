...
static t_config_enum_values s_keys_map_WipeTowerType{{"type1", int(WipeTowerType::Type1)}, {"type2", int(WipeTowerType::Type2)}};
...
void PrintConfigDef::init_fff_params()
{
    ...
    */
    ...
    def->tooltip = L(
        "When enabled, the extrusion flow is limited by the smaller of "
    ...
    def->tooltip = L(
        "Choose the wipe tower implementation for multi-material prints. Type 1 is recommended for Bambu and Qidi printers with a filament "
        "cutter. Type 2 offers better compatibility with multi-tool and MMU printers and provide overall better compatibility.");
...
TemperaturesConfigDef::TemperaturesConfigDef()
{
    ...
    new_def("bed_temperature", coInts, "Bed temperature", "Vector of bed temperatures for each extruder/filament.") new_def(
        "bed_temperature_initial_layer", coInts, "First layer bed temperature",
        "Vector of first layer bed temperatures for each extruder/filament. Provides the same value as first_layer_bed_temperature.")
        new_def("bed_temperature_initial_layer_single", coInt, "First layer bed temperature (initial extruder)",
                "First layer bed temperature for the initial extruder. Same as bed_temperature_initial_layer[initial_extruder]")
