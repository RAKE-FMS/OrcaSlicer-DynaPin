...
PRINT_CONFIG_CLASS_DERIVED_DEFINE(
    ...
    ((ConfigOptionFloat, initial_layer_infill_speed))((ConfigOptionInts, nozzle_temperature_initial_layer))(
        ...
        (ConfigOptionString, printer_model))((ConfigOptionString, dynapin_config_path))((ConfigOptionFloat, resolution))(
        (ConfigOptionFloats, retraction_minimum_travel))((ConfigOptionBools, retract_when_changing_layer))(
        (ConfigOptionFloat, skirt_distance))((ConfigOptionInt, skirt_height))((ConfigOptionInt, skirt_loops))(
        (ConfigOptionEnum<SkirtType>, skirt_type))((ConfigOptionFloat, skirt_speed))((ConfigOptionBool, single_loop_draft_shield))(
        (ConfigOptionFloat, min_skirt_length))((ConfigOptionFloats, slow_down_layer_time))((ConfigOptionBool, spiral_mode))(
        (ConfigOptionBool, spiral_mode_smooth))((ConfigOptionFloatOrPercent, spiral_mode_max_xy_smoothing))((ConfigOptionFloat,
    ...
    ((ConfigOptionFloat, preferred_orientation))((ConfigOptionPoint, bed_mesh_min))((ConfigOptionPoint, bed_mesh_max))(
        ...
        (ConfigOptionBool, enable_dynapin_support_optimization))((ConfigOptionBool, enable_dynapin_placement_optimization))(
